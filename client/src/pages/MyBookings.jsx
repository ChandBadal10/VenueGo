...
function StatusBadge({ status }) {
  const styles = {
    confirmed: "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300", // DARK MODE
    cancelled: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300", // DARK MODE
  };

  return (
    <span
      className={`text-xs px-2.5 py-1 rounded-full font-medium capitalize ${
        styles[status] || "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300" // DARK MODE
      }`}
    >
      {status}
    </span>
