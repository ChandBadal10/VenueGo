...
const VenueCard = () => {
  ...
  return (
    <div className="px-6 pb-20 max-w-7xl mx-auto mt-20 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      <h2 className="text-3xl font-bold text-center mb-3 text-gray-900 dark:text-gray-100">Popular Venues</h2>
      <p className="text-center text-gray-600 dark:text-gray-300 mb-8">
        Discover and book the best sports venues near you
      </p>

      {/* Filter Bar */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-4 mb-8 transition-colors duration-300">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none dark:bg-gray-700 dark:text-gray-100 transition-colors duration-300"
            />
          </div>
          ...
          <div className="relative min-w-[200px]">
            ...
            <select
              ...
              className="w-full pl-12 pr-10 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none bg-white dark:bg-gray-700 dark:text-gray-100 cursor-pointer transition-colors duration-300"
            >
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10">
        ...
        {filteredVenues.slice(0, 6).map((venue) => {
          ...
          return (
            <div
              key={venue._id}
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl border border-gray-200 dark:border-gray-700 transition overflow-hidden cursor-pointer transition-colors duration-300"
            ...
            >
              ...
              <div className="p-5">
                <h3 className="font-semibold text-lg text-gray-900 dark:text-gray-100">{venue.venueName}</h3>
                ...
                <button
                  ...
                  className="mt-4 w-full bg-blue-600 text-white py-2.5 rounded-xl hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors duration-300 font-medium"
                >
                  Book Now
                </button>
              </div>
      ...
      {filteredVenues.length > 6 && (
        <div className="text-center mt-10">
          <button
            ...
            className="px-8 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors duration-300 font-medium"
          >
