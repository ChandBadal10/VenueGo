...
const Testimonial = () => {
  return (
    <div className="flex md:flex-row flex-col gap-5 flex justify-center  mb-20">
      ...
      <div className="w-80 flex flex-col items-center border border-gray-300 p-10 rounded-lg">
        ...
        <p className="text-sm text-gray-500">Crickter</p>
        <div className="flex items-center justify-center mt-3 gap-1">
          <svg
            width="16"
            height="15"
        ...
        <p className="text-center text-[15px] mt-3 text-gray-500">
          ...
          conditions are always excellent, making every match smooth, enjoyable,
          and truly memorable..
        </p>
      </div>
      ...
      <div className="w-80 flex flex-col items-center border border-gray-300 p-10 rounded-lg">
        <img
          ...
          alt="userImage3"
        />
        <h2 className="text-lg text-gray-900 font-medium mt-2">Sagal Chand</h2>
        ...
        <p className="text-center text-[15px] mt-3 text-gray-500">
          ...
          the smooth playing surface and great environment make every session
