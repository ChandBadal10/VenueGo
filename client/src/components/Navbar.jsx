    ...
    >
      ...
      <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
        <button
          onClick={async () => {
            ...
            try {
              ...
              if (!data.exists) {
                // toast.error("You must register a venue first.");
                navigate("/owner"); // redirect to venue registration page
        ...
        <button
          ...
          className="cursor-pointer px-8 py-2 bg-blue-600 hover:bg-blue-600 transition-all text-white rounded-lg"
        >
          {user ? "Logout" : "Login"}{" "}
        </button>
      </div>
